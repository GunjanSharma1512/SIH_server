...
def mse(imageA, imageB):
    ...
    # numpy.dot(imageA.shape), imageB.shape)).shape
...
original = cv2.imread("image_test4.jpeg")
contrast = cv2.imread("image_test5.jpeg")
...
# shopped = cv2.imread("./images/photoshopped.jpg")
